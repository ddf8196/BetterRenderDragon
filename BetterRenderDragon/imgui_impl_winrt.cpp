...
static ImGuiKey ImGui_ImplWinRT_VirtualKeyToImGuiKey(ABI::Windows::System::VirtualKey vk) {
	...
	switch (vk) {
	case VirtualKey::VirtualKey_Tab : return ImGuiKey_Tab;
	case VirtualKey::VirtualKey_Left: return ImGuiKey_LeftArrow;
	case VirtualKey::VirtualKey_Right: return ImGuiKey_RightArrow;
	case VirtualKey::VirtualKey_Up: return ImGuiKey_UpArrow;
	case VirtualKey::VirtualKey_Down: return ImGuiKey_DownArrow;
	case VirtualKey::VirtualKey_PageUp: return ImGuiKey_PageUp;
	case VirtualKey::VirtualKey_PageDown: return ImGuiKey_PageDown;
	case VirtualKey::VirtualKey_Home: return ImGuiKey_Home;
	case VirtualKey::VirtualKey_End: return ImGuiKey_End;
	case VirtualKey::VirtualKey_Insert: return ImGuiKey_Insert;
	case VirtualKey::VirtualKey_Delete: return ImGuiKey_Delete;
	case VirtualKey::VirtualKey_Back: return ImGuiKey_Backspace;
	case VirtualKey::VirtualKey_Space: return ImGuiKey_Space;
	case VirtualKey::VirtualKey_Enter: return ImGuiKey_Enter;
	case VirtualKey::VirtualKey_Escape: return ImGuiKey_Escape;
	...
	case VirtualKey::VirtualKey_CapitalLock: return ImGuiKey_CapsLock;
	case VirtualKey::VirtualKey_Scroll: return ImGuiKey_ScrollLock;
	case VirtualKey::VirtualKey_NumberKeyLock: return ImGuiKey_NumLock;
	case VirtualKey::VirtualKey_Snapshot: return ImGuiKey_PrintScreen;
	case VirtualKey::VirtualKey_Pause: return ImGuiKey_Pause;
	case VirtualKey::VirtualKey_NumberPad0: return ImGuiKey_Keypad0;
	case VirtualKey::VirtualKey_NumberPad1: return ImGuiKey_Keypad1;
	case VirtualKey::VirtualKey_NumberPad2: return ImGuiKey_Keypad2;
	case VirtualKey::VirtualKey_NumberPad3: return ImGuiKey_Keypad3;
	case VirtualKey::VirtualKey_NumberPad4: return ImGuiKey_Keypad4;
	case VirtualKey::VirtualKey_NumberPad5: return ImGuiKey_Keypad5;
	case VirtualKey::VirtualKey_NumberPad6: return ImGuiKey_Keypad6;
	case VirtualKey::VirtualKey_NumberPad7: return ImGuiKey_Keypad7;
	case VirtualKey::VirtualKey_NumberPad8: return ImGuiKey_Keypad8;
	case VirtualKey::VirtualKey_NumberPad9: return ImGuiKey_Keypad9;
	case VirtualKey::VirtualKey_Decimal: return ImGuiKey_KeypadDecimal;
	case VirtualKey::VirtualKey_Divide: return ImGuiKey_KeypadDivide;
	case VirtualKey::VirtualKey_Multiply: return ImGuiKey_KeypadMultiply;
	case VirtualKey::VirtualKey_Subtract: return ImGuiKey_KeypadSubtract;
	case VirtualKey::VirtualKey_Add: return ImGuiKey_KeypadAdd;
	case VirtualKey::VirtualKey_LeftShift: return ImGuiKey_LeftShift;
	case VirtualKey::VirtualKey_LeftControl: return ImGuiKey_LeftCtrl;
	case VK_LMENU: return ImGuiKey_LeftAlt;
	case VK_LWIN: return ImGuiKey_LeftSuper;
	case VirtualKey::VirtualKey_RightShift: return ImGuiKey_RightShift;
	case VirtualKey::VirtualKey_RightControl: return ImGuiKey_RightCtrl;
	case VK_RMENU: return ImGuiKey_RightAlt;
	case VK_RWIN: return ImGuiKey_RightSuper;
	case VirtualKey::VirtualKey_Control: return ImGuiKey_LeftCtrl;
	case VirtualKey::VirtualKey_Shift: return ImGuiKey_LeftShift;
	case VirtualKey::VirtualKey_Application: return ImGuiKey_Menu;
	case VirtualKey::VirtualKey_Number0: return ImGuiKey_0;
	case VirtualKey::VirtualKey_Number1: return ImGuiKey_1;
	case VirtualKey::VirtualKey_Number2: return ImGuiKey_2;
	case VirtualKey::VirtualKey_Number3: return ImGuiKey_3;
	case VirtualKey::VirtualKey_Number4: return ImGuiKey_4;
	case VirtualKey::VirtualKey_Number5: return ImGuiKey_5;
	case VirtualKey::VirtualKey_Number6: return ImGuiKey_6;
	case VirtualKey::VirtualKey_Number7: return ImGuiKey_7;
	case VirtualKey::VirtualKey_Number8: return ImGuiKey_8;
	case VirtualKey::VirtualKey_Number9: return ImGuiKey_9;
	case VirtualKey::VirtualKey_A: return ImGuiKey_A;
	case VirtualKey::VirtualKey_B: return ImGuiKey_B;
	case VirtualKey::VirtualKey_C: return ImGuiKey_C;
	case VirtualKey::VirtualKey_D: return ImGuiKey_D;
	case VirtualKey::VirtualKey_E: return ImGuiKey_E;
	case VirtualKey::VirtualKey_F: return ImGuiKey_F;
	case VirtualKey::VirtualKey_G: return ImGuiKey_G;
	case VirtualKey::VirtualKey_H: return ImGuiKey_H;
	case VirtualKey::VirtualKey_I: return ImGuiKey_I;
	case VirtualKey::VirtualKey_J: return ImGuiKey_J;
	case VirtualKey::VirtualKey_K: return ImGuiKey_K;
	case VirtualKey::VirtualKey_L: return ImGuiKey_L;
	case VirtualKey::VirtualKey_M: return ImGuiKey_M;
	case VirtualKey::VirtualKey_N: return ImGuiKey_N;
	case VirtualKey::VirtualKey_O: return ImGuiKey_O;
	case VirtualKey::VirtualKey_P: return ImGuiKey_P;
	case VirtualKey::VirtualKey_Q: return ImGuiKey_Q;
	case VirtualKey::VirtualKey_R: return ImGuiKey_R;
	case VirtualKey::VirtualKey_S: return ImGuiKey_S;
	case VirtualKey::VirtualKey_T: return ImGuiKey_T;
	case VirtualKey::VirtualKey_U: return ImGuiKey_U;
	case VirtualKey::VirtualKey_V: return ImGuiKey_V;
	case VirtualKey::VirtualKey_W: return ImGuiKey_W;
	case VirtualKey::VirtualKey_X: return ImGuiKey_X;
	case VirtualKey::VirtualKey_Y: return ImGuiKey_Y;
	case VirtualKey::VirtualKey_Z: return ImGuiKey_Z;
	case VirtualKey::VirtualKey_F1: return ImGuiKey_F1;
	case VirtualKey::VirtualKey_F2: return ImGuiKey_F2;
	case VirtualKey::VirtualKey_F3: return ImGuiKey_F3;
	case VirtualKey::VirtualKey_F4: return ImGuiKey_F4;
	case VirtualKey::VirtualKey_F5: return ImGuiKey_F5;
	case VirtualKey::VirtualKey_F6: return ImGuiKey_F6;
	case VirtualKey::VirtualKey_F7: return ImGuiKey_F7;
	case VirtualKey::VirtualKey_F8: return ImGuiKey_F8;
	case VirtualKey::VirtualKey_F9: return ImGuiKey_F9;
	case VirtualKey::VirtualKey_F10: return ImGuiKey_F10;
	case VirtualKey::VirtualKey_F11: return ImGuiKey_F11;
	case VirtualKey::VirtualKey_F12: return ImGuiKey_F12;
...
ImGuiInputEventHandler::ImGuiInputEventHandler(ICoreWindow* window) : window(window) {
	typedef ABI::Windows::Foundation::ITypedEventHandler<ABI::Windows::UI::Core::CoreWindow*, ABI::Windows::UI::Core::PointerEventArgs*> PointerEventHandler;
